...
const Footer: React.FC = () => {
  const brandName = process.env.REACT_APP_BRAND_NAME || 'Astreon';
  ...
  const companyPhone = process.env.REACT_APP_PHONE_DISPLAY || '+14195154912';
  const supportEmail = process.env.REACT_APP_EMAIL_SUPPORT || 'support@goldleaftravelsavings.com';
