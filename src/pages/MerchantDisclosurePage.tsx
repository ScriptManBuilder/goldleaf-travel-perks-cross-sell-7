      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Primary Descriptor:</strong> "GOLDLEAF TRAVEL" or "GOLDLEAF*[Travel Service]"
              </LegalListItem>
              <LegalListItem>
                <strong>Alternative Descriptors:</strong> May include "ASTREON" or travel provider names for specific bookings
              </LegalListItem>
              <LegalListItem>
